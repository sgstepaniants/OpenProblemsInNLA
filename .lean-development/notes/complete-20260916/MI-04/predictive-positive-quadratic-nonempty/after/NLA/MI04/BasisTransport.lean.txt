...
lemma orthonormal_pair_set {n : ℕ} (u v : CVector (Fin n))
  ...
  rcases hx with rfl | rfl <;> rcases hy with rfl | rfl <;>
    simp [huu, hvv, huv, hvu, hne, Ne.symm hne]
...
lemma basisUnitary_entry {n : ℕ} (B : OrthonormalBasis (Fin n) ℂ (CVector (Fin n)))
  ...
  simp [basisUnitary, Basis.toMatrix_apply, OrthonormalBasis.coe_toBasis_repr_apply,
...
lemma unitarySimilarity_entry_basis {n : ℕ} (X : Square n)
  ...
  rw [← matrixCoefficient_coordinateUnits, matrixCoefficient_unitarySimilarity,
    basisUnitary_action, basisUnitary_action]
